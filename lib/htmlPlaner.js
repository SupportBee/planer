...
(function() {
  ...
  exports.wrapMicrosoftQuote = function(emailDocument) {
    var afterSplitter, parentElement, splitterElement, wrapper;
    splitterElement = findMicrosoftSplitter(emailDocument);
    if (splitterElement == null) {
      return false;
    }
  ...
  exports.wrapFromBlock = function(emailDocument) {
    var afterSplitter, parentElement, splitterElement, wrapper, xpathQuery, xpathResult;
    xpathQuery = "//*[starts-with(normalize-space(.), 'From:')]|//*[starts-with(normalize-space(.), 'Date:')]";
